...
_equal(a::ANSIColor, b::ANSIColor) =
    a.r == b.r && a.g == b.g && a.b == b.b && a.style == b.style
...
# Similar to above
_incremental_add(a::ANSIStyle, b::ANSIStyle, incremental::Bool) =
    b.active ? ANSIStyle(b.on, !_equal(a, b) || !incremental) :
    ANSIStyle(a.on, !incremental)
...
_incremental_sub(a::ANSIColor, b::ANSIColor, incremental::Bool) =
    ANSIColor(b.r, b.g, b.b, b.style, !_equal(a, b) || !incremental)
_incremental_sub(a::ANSIStyle, b::ANSIStyle, incremental::Bool) =
    ANSIStyle(b.on, !_equal(a, b) || !incremental)
